...
* [Setup on Mac OS X](https://github.com/projekkripto/ultra/tree/master/doc/setup-local-osx.md)
* [Setup on Ubuntu](https://github.com/projekkripto/ultra/tree/master/doc/setup-local-ubuntu.md)
* [Deploy production server](https://github.com/projekkripto/ultra/tree/master/doc/deploy-production-server.md)
* [Setup Ethereum Server](https://github.com/projekkripto/ultra/tree/master/doc/eth.md)
